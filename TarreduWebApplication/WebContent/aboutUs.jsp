...
<body>
	...
	<img src="images/sfondoLegno.png" id="bg">
	...
	<header class="container-fluid headerImage row">
		<div class="headerContainer col-md-12"
			style="text-align: center; padding-bottom: 0; padding-top: 0;">
	...
	<div class="container containerSezioneSuperiore">
		...
		<div class="row">
			...
			<div class="col-md-8 descrizione">
				...
				<p>Scelto il prodotto da acquistare l'utente potrà richiedere
					un preventivo o contattare il venditore per l'acquisto.</p>
				<p>L'utente può lasciare feedback sul singolo prodotto o sul
					venditore dopo aver effettuato l'acquisto.</p>
				<p>Il sito prevede anche una chat live per assistenza e
					supporto.</p>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6 immagineComponente">
					<div class="card">
						...
						<p>
							<button>
								<a href="mailto:xblack90@hotmail.it" class="componentiContatti">E-mail</a>
							</button>
						</p>
						<p>
							<button>
